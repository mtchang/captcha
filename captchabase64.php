...
// ----
// 修改： mtchang <mtchang.tw@gmail.com>
// 改成只顯示數字的的 cpatcha , 去除扭曲的部份, 使用 base64 輸出為文字檔案，提供給 <img =src=""> 使用
// 去除有問題空白的文字，只留下 個文字選項。
// 去除字典檔的使用, 用亂術產生數字
// ----
...
class SimpleCaptcha {
    ...
    // public $wordsFile = 'words/gpk.php';
    ...
    */
    // fix by mtchang.tw@gmail.com
    public $fonts = array(
        'VeraSans' => array('spacing' => 0, 'minSize' => 14, 'maxSize' => 14, 'font' => 'VeraSansBold.ttf'),
    );

	// 沒有數字的字形, 需要去除
    // 'Heineken' => array('spacing' => 1, 'minSize' => 18, 'maxSize' => 24, 'font' => 'Heineken.ttf'),
    ...
    */
    ...
    function GetDictionaryCaptchaText($extended = false) {
        ...
        // 隨機產生 4 個亂數
        // by mtchang.tw@gmail.com  2016.6.12
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $x      = 10*$this->scale;
        $y      = round(($this->height*32/40)*$this->scale);
        $length = strlen($text);
        for ($i=0; $i<$length; $i++) {
